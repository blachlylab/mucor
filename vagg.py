...
# vaggregate modules
import vaggregatefilters as mf
from variant import Variant
from vaggregatefeature import VaggregateFeature
import inputs
import output
...
def constructGAS(gffFile, featureType, knownFeatures, duplicateFeatures, union):
    ...
    for feature in itertools.islice(gffFile, 0, None):
        ...
        # transform feature to instance of Class VaggregateFeature
        feat = VaggregateFeature(feature.attr[featureType], feature.type, feature.iv)
        ...
        # first, add to the knownFeatures, a dictionary of VaggregateFeatures, which contain the variants set
